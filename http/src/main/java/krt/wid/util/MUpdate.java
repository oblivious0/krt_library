...
public class MUpdate {
    ...
    private void createBaseDialog() {
        ...
        dialog.show();
        dialog.getButton(dialog.BUTTON_POSITIVE).setTextColor(ContextCompat.getColor(mContext, R.color.color_1b9ef7));
        dialog.getButton(dialog.BUTTON_NEGATIVE).setTextColor(ContextCompat.getColor(mContext, R.color.color_1b9ef7));
    }
